<?php
	...
	// Rôle : cette vue permet de réaliser une annulation de réservation par l'utilisateur concerné
	// cette vue est appelée par le contôleur controleurs/CtrlAnnulerReservation.php
	// Création : 07/11/2017 par Pierre
    // Mise à jour : 07/11/2017 par Pierre
?>
<!DOCTYPE html>
<html>
<head>
		...
		<div data-role="content">
			...
			<form id="formModificationMdp" action="#" method="post" data-ajax="false">
				<div data-role="fieldcontain">
					<input type="text"
					 name="txtReservation" id="txtReservation" 
